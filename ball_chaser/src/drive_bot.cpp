...
bool handle_drive_request(ball_chaser::DriveToTarget::Request& req, ball_chaser::DriveToTarget::Response& res)
{
    ...
    // Publish the requested linear x and angular velocities to drive the robot
...
int main(int argc, char** argv)
{
    ...
    // Define /ball_chaser/command_robot service with a handle_drive_request callback function
